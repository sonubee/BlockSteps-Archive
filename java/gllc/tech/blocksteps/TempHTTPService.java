 ...
 */
public class TempHTTPService extends Service {
    ...
    public TempHTTPService(String url, CloseableHttpClient httpClient) {
        this.url = url;
        this.httpClient = httpClient;
    }

    public TempHTTPService(String url) {
        this(url, HttpClients.custom().setConnectionManagerShared(true).build());
    }

    public TempHTTPService() {
        this(DEFAULT_URL);
    }
